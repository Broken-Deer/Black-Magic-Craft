            ...
            $.get(
                ...
                function (data, textStatus, jqXHR) {
                    if (jqXHR.status == 200) {
                        ...
                        console.log(_version_list.length);
                        for (let i = 0; i < _version_list.length; i++) {
                            ...
                            if (
                                version_info["type"] == "old_beta" ||
                                version_info["type"] == "old_alpha"
                            ) {
                            ...
                            <li>
                                <div class="a">
                                    ...
                                    <div class="info">
                                        ...
                                        <span>发布于${date.getFullYear()}年${
                                date.getMonth() + 1
                            }月${date.getDate()}日 ${type}</span>
                                    </div>
                                </div>
                                <div class="button download" onclick="install_game('${
                                    version_info["url"]
                                }', '${version_info["id"]}')">
                                    <i></i>
                                </div>
                        ...
                        $(
                            document.getElementById("_version_list")
                                .lastElementChild
                        ).remove(); /* 移除最后一条分割线 */
                    } else {
                        // 失败后的操作;
